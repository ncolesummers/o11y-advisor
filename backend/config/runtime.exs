...
#
#     PHX_SERVER=true bin/o11y_advisor start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :o11y_advisor, O11yAdvisorWeb.Endpoint, server: true
end

if config_env() == :test do
  if url = System.get_env("DATABASE_URL") do
    config :o11y_advisor, O11yAdvisor.Repo, url: url
  end
end
...
if config_env() == :prod do
  ...
  config :o11y_advisor, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
